// Copied from https://github.com/lsfusion/platform/blob/44c63603a451e8b6616980b6772b01d877ee96a2/api/src/main/java/lsfusion/base/col/heavy/concurrent/weak/ConcurrentWeakHashMap.java
// Edited slightly.
 ...
 * @version revision 5470 from <a href="http://viewvc.jboss.org/cgi-bin/viewvc.cgi/jbosscache/experimental/jsr166/src/jsr166y/">...</a>
 */
...
public class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable {
   ...
   * otherwise specified in a constructor.
   */
  // https://github.com/lsfusion/platform/blob/44c63603a451e8b6616980b6772b01d877ee96a2/api/src/main/java/lsfusion/base/col/lru/LRUUtil.java#L232
  static final int DEFAULT_CONCURRENCY_LEVEL = Runtime.getRuntime().availableProcessors() * 8;
   ...
   */
  @SuppressWarnings({"EqualsReplaceableByObjectsCall", "rawtypes", "PatternVariableCanBeUsed"})
